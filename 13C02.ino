...
#define _POS_START (_DUTY_MIN + 0)    // servo start position
#define _POS_END   (_DUTY_MAX - 0)    // servo end position
...
void setup() {
  ...
  toggle_interval = (SERVO_RANGE_DEG / _SERVO_SPEED) * 1000 / INTERVAL;
